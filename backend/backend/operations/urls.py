...
from operations.views import ApprovalRuleViewSet, ApprovalRequestViewSet
...
from django.urls import path, include
from rest_framework.routers import DefaultRouter
from operations.views import NotificationViewSet, EmailQueueViewSet, SMSQueueViewSet
