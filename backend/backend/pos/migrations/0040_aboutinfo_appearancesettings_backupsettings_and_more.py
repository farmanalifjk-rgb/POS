# Generated by Django 6.0.6 on 2026-07-20 20:02

import django.db.models.deletion
import pos.modules.system.models
import secrets
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='company',
            name='business_type',
            field=models.CharField(blank=True, choices=[('retail', 'Retail'), ('restaurant', 'Restaurant'), ('grocery', 'Grocery'), ('pharmacy', 'Pharmacy'), ('salon', 'Salon / Services'), ('wholesale', 'Wholesale'), ('other', 'Other')], default='retail', max_length=30),
        ),
        migrations.AddField(
            model_name='company',
            name='city',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, default='Thank you for your purchase!', max_length=255),
        ),
        migrations.AddField(
            model_name='customer',
            name='date_of_birth',
        ...
        migrations.AddField(
            model_name='paymentmethod',
            name='icon',
            field=models.CharField(blank=True, default='wallet', help_text='Lucide icon name', max_length=50),
        ),
        migrations.AddField(
            model_name='product',
            name='batch_number',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=150)),
                ('key', models.CharField(default=pos.modules.system.models.generate_api_key, editable=False, max_length=80, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to=pos.modules.system.models.backup_file_path)),
        ...
        migrations.AddField(
            model_name='customer',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customers', to='pos.customergroup'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('default_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='pos.brand')),
                ('default_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='pos.category')),
                ('default_tax', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='pos.tax')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('webhook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deliveries', to='pos.webhook')),
            ],
            options={
                'ordering': ['-created_at'],
            },
