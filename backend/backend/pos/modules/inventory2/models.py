...
class BinLocation(models.Model):
    ...
    warehouse = models.ForeignKey("pos.Warehouse", on_delete=models.CASCADE, related_name="bins")
...
class StockReservation(models.Model):
    ...
    warehouse = models.ForeignKey("pos.Warehouse", null=True, blank=True, on_delete=models.SET_NULL, related_name="reservations")
...
class CycleCount(models.Model):
    ...
    warehouse = models.ForeignKey("pos.Warehouse", null=True, blank=True, on_delete=models.SET_NULL, related_name="cycle_counts")
...
class ReorderRule(models.Model):
    ...
    warehouse = models.ForeignKey("pos.Warehouse", null=True, blank=True, on_delete=models.CASCADE, related_name="reorder_rules")
